...
public class SignInPageandForgetPasswordTestDev extends StartWebDriver {
...
//			WebElement ele = driver.findElement(By.xpath("//span[text()='What was your childhood nickname?']"));
			try {
			if(driver.findElement(By.xpath("//span[text()='What is the name of your favorite childhood friend?']")) != null)
