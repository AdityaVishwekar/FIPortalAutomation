...
public class ReportPage_PendingEnrollmentsReport extends StartWebDriver {

	@Test
	public void testPendingEnrollmentsReport() throws Exception {
		...
		LinkHelper.clickLink("Pending Enrollment Report");
